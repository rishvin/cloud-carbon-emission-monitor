web: export FLASK_APP=src/apps/carbon_emission_app.py; flask run --port=$PORT
services: docker run -d --rm --name rabbitmq -p 5672:5672 -p 15672:15672 rabbitmq:3.11-management; \
          sleep 1; \
